...
use type PlantUML2Code_Formats.Format;
use type PlantUML2Code_Ansi.Color_Mode;
...
package body Test_CLI is
   ...
   begin
      ...
      Assert (R.Format = PlantUML2Code_Formats.Text, "default format");
   ...
   begin
      Assert (R.Ok, "ok");
      Assert (R.Format = PlantUML2Code_Formats.Json, "json");
      Assert (Natural (R.Files.Length) = 1, "one file");
   ...
   begin
      Assert (R.Ok, "ok");
      Assert (R.Format = PlantUML2Code_Formats.Ada_HSM, "ada");
   ...
   begin
      Assert (R.Ok, "ok");
      Assert (R.Color = PlantUML2Code_Ansi.Never, "never");
   ...
   begin
      Assert (R.Ok, "ok");
      Assert (R.Color = PlantUML2Code_Ansi.Always, "always");
