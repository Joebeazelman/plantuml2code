...
package body Uml2Code_CLI is
   ...
   is
   begin
      Result.Format := Uml2Code_Formats.Parse (S);
   exception
   ...
   begin
      if S = "auto" then
         Result.Color := Uml2Code_Ansi.Auto;
      elsif S = "always" then
         Result.Color := Uml2Code_Ansi.Always;
      elsif S = "never" then
         Result.Color := Uml2Code_Ansi.Never;
      else
         ...
         while I <= Total loop
            ...
            begin
               ...
               then
                  ...
                  Hint ("run '" & Uml2code_Config.Crate_Name
                        & " help'");
                  return Result;
