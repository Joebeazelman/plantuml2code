...
package body HistoryTest is
   ...
   procedure Step_Outer (Self : in out Machine; On : Outer_Machine.Event) is
   begin
   ...
   procedure Step_Outer_Middle
     (Self : in out Machine; On : Middle_Machine.Event) is
   begin
      if Current_State (Self) = Outer then
   ...
   procedure Step_Outer_Middle_Inner
     (Self : in out Machine; On : Inner_Machine.Event) is
   begin
      if Current_State (Self) = Outer then
   ...
   function Outer_Middle_Inner_State
     (Self : Machine) return Inner_Machine.State is
   begin
      if Current_State (Self) = Outer then
