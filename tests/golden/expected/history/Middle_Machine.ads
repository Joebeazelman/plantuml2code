...
package Middle_Machine is
   ...
   type State is (Start_State, Inner);
   ...
   package Base is new
     State_Machine.Machines (State => State, Event => Event, Initial => Inner);
   ...
   procedure Step_Inner (Self : in out Machine; On : Inner_Machine.Event);
