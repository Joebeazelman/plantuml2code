...
package body Running_Machine_Tests is
   ...
   begin
      Assert
        (Transition (Spinning, Yield) = Waiting,
   ...
   begin
      Assert
        (Transition (Waiting, Resume) = Spinning,
   ...
   begin
      Register_Routine
        (T, Test_Spinning_Yield'Access, "Spinning --Yield--> Waiting");
      Register_Routine
        (T, Test_Waiting_Resume'Access, "Waiting --Resume--> Spinning");
      null;
   end Register_Tests;
