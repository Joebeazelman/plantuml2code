...
package Nested is
   ...
   type State is (Start_State, Idle, Running, End_State);

   type Event is (Start, Continue, Stop, Finish, Tick);
   ...
   procedure Step_Running (Self : in out Machine; On : Running_Machine.Event);
